...
class myApp(tb.Window):
    def __init__(self):
        ...
        for f in (mainMenu, mainAluno, getMatricula, getLogin, mainProf):
...
class mainMenu(ttk.Frame):
    def __init__(self, parent, control):
        ...
        label.pack(side="top")
        button1 = myButton(self, text="Alunos", command=lambda: control.showpage("getMatricula"))
        button1.pack(pady=10)
        button2 = myButton(self, text="Professor", command=lambda: control.showpage("getLogin"))
